...
**Shijunqiang/weather-classification-swin-coatnet**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/Shijunqiang/weather-classification-swin-coatnet)

**LuffyTheFox/Qwen3.6-35B-A3B-Uncensored-Genesis-Hermes-V6-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 99,660 downloads, 222 likes
- [🤗 View on HuggingFace](https://huggingface.co/LuffyTheFox/Qwen3.6-35B-A3B-Uncensored-Genesis-Hermes-V6-GGUF)

**rijal028/training-qwenresfinale1-6-028-seed42new**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rijal028/training-qwenresfinale1-6-028-seed42new)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AnkitAI/Parable-SmolLM3-3B-Claude-Fable-5)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/teriro/my-fusion-v1)
...
Today's research firehose scanned **418 papers** and surfaced **3 breakthrough papers** 【metrics:1】 across **6 research clusters** 【patterns:1】. Here's what you can build with it—right now.
