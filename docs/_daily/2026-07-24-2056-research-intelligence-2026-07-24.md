...
- Type: dataset
- Research Score: 0.50
- Community Interest: 25,400 downloads, 337 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/Nanthasit/sakthai-coder-1.5b)

**inferencerlabs/Macaron-V1-Coding-Venti-MLX-Q4.8-INF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/inferencerlabs/Macaron-V1-Coding-Venti-MLX-Q4.8-INF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Irfanuruchi/Qwen3-4B-Computer-Science)
...
- [🤗 View on HuggingFace](https://huggingface.co/XYZAILab/XYZ-Aquila-pro)
