---
layout: default
title: "AI Research Intelligence – 2026-03-17"
date: 2026-03-17 20:31:41 +0000
...
permalink: /daily/2026/03/17/research-intelligence-2026-03-17/
...
### 1. FairMed-XGB: A Bayesian-Optimised Multi-Metric Framework with Explainability for Demographic Equity in Critical Healthcare Data

**Authors**: Mitul Goswami et al.  
**Research Score**: 0.81 (Highly Significant)  
**Source**: arxiv  

**Core Contribution**: Machine learning models deployed in critical care settings exhibit demographic biases, particularly gender disparities, that undermine clinical trust and equitable treatment. This paper introduces FairMed-XGB, a novel framework that systematically detects and mitigates gender-based prediction bias w...
...
[📄 Read Paper](https://arxiv.org/abs/2603.14947v1)
...
**DeFRiS: Silo-Cooperative IoT Applications Scheduling via Decentralized Federated Reinforcement Learning** (Score: 0.79)

Next-generation IoT applications increasingly span across autonomous administrative entities, necessitating silo-cooperative scheduling to leverage diverse computational resources while preserving dat... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2603.14729v1)

**Computational Analysis of Semantic Connections Between Herman Melville Reading and Writing** (Score: 0.79)

This study investigates the potential influence of Herman Melville reading on his own writings through computational semantic similarity analysis. Using documented records of books known to have been ... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2603.14674v1)

**POLCA: Stochastic Generative Optimization with LLM** (Score: 0.77)

Optimizing complex systems, ranging from LLM prompts to multi-turn agents, traditionally requires labor-intensive manual iteration. We formalize this challenge as a stochastic generative optimization ... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2603.14769v1)
...
**piyazon/Wav2Vec2-with-punctuation**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/piyazon/Wav2Vec2-with-punctuation)
...
- [🤗 View on HuggingFace](https://huggingface.co/khazarai/Qwen3-4B-Kimi2.5-Reasoning-Distilled-GGUF)

**timdef/smollm3-dpo-aligned**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/timdef/smollm3-dpo-aligned)

**Seok-yeong/reuters-distilbert-finetuned-pro**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Seok-yeong/reuters-distilbert-finetuned-pro)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LorenaYannnnn/general_reward-Qwen3-0.6B-baseline_cot_only-seed_2)
...
- [RAZOR: Ratio-Aware Layer Editing for Targeted Unlearning in Vision Transformers and Diffusion Models](https://arxiv.org/abs/2603.14819v1)
- [ASAP: Attention-Shift-Aware Pruning for Efficient LVLM Inference](https://arxiv.org/abs/2603.14549v1)
- [CAMD: Coverage-Aware Multimodal Decoding for Efficient Reasoning of Multimodal Large Language Models](https://arxiv.org/abs/2603.14745v1)
...
- [LLMind: Bio-inspired Training-free Adaptive Visual Representations for Vision-Language Models](https://arxiv.org/abs/2603.14882v1)
...
**Papers in this cluster**:
- [DeFRiS: Silo-Cooperative IoT Applications Scheduling via Decentralized Federated Reinforcement Learning](https://arxiv.org/abs/2603.14729v1)
- [POLCA: Stochastic Generative Optimization with LLM](https://arxiv.org/abs/2603.14769v1)
- [EcoFair-CH-MARL: Scalable Constrained Hierarchical Multi-Agent RL with Real-Time Emission Budgets and Fairness Guarantees](https://arxiv.org/abs/2603.14625v1)
- [VisionCoach: Reinforcing Grounded Video Reasoning via Visual-Perception Prompting](https://arxiv.org/abs/2603.14659v1)
- [Parameter-Efficient Quality Estimation via Frozen Recursive Models](https://arxiv.org/abs/2603.14593v1)
...
**Papers in this cluster**:
- [Computational Analysis of Semantic Connections Between Herman Melville Reading and Writing](https://arxiv.org/abs/2603.14674v1)
- [POLCA: Stochastic Generative Optimization with LLM](https://arxiv.org/abs/2603.14769v1)
- [EcoFair-CH-MARL: Scalable Constrained Hierarchical Multi-Agent RL with Real-Time Emission Budgets and Fairness Guarantees](https://arxiv.org/abs/2603.14625v1)
- [Parameter-Efficient Quality Estimation via Frozen Recursive Models](https://arxiv.org/abs/2603.14593v1)
- [FlashHead: Efficient Drop-In Replacement for the Classification Head in Language Model Inference](https://arxiv.org/abs/2603.14591v1)
...
- [DeFRiS: Silo-Cooperative IoT Applications Scheduling via Decentralized Federated Reinforcement Learning](https://arxiv.org/abs/2603.14729v1)
- [VisionCoach: Reinforcing Grounded Video Reasoning via Visual-Perception Prompting](https://arxiv.org/abs/2603.14659v1)
- [Informative Perturbation Selection for Uncertainty-Aware Post-hoc Explanations](https://arxiv.org/abs/2603.14894v1)
- [RAZOR: Ratio-Aware Layer Editing for Targeted Unlearning in Vision Transformers and Diffusion Models](https://arxiv.org/abs/2603.14819v1)
- [ASAP: Attention-Shift-Aware Pruning for Efficient LVLM Inference](https://arxiv.org/abs/2603.14549v1)
...
- [Parameter-Efficient Quality Estimation via Frozen Recursive Models](https://arxiv.org/abs/2603.14593v1)
- [FlashHead: Efficient Drop-In Replacement for the Classification Head in Language Model Inference](https://arxiv.org/abs/2603.14591v1)
- [CausalEvolve: Towards Open-Ended Discovery with Causal Scratchpad](https://arxiv.org/abs/2603.14575v1)
- [ASAP: Attention-Shift-Aware Pruning for Efficient LVLM Inference](https://arxiv.org/abs/2603.14549v1)
...
- FairMed-XGB: A Bayesian-Optimised Multi-Metric Framework wit... (watch for citations and replications)
- DeFRiS: Silo-Cooperative IoT Applications Scheduling via Dec... (watch for citations and replications)
- Computational Analysis of Semantic Connections Between Herma... (watch for citations and replications)
...
Today's research firehose scanned **443 papers** and surfaced **1 breakthrough papers** 【metrics:1】 across **6 research clusters** 【patterns:1】. Here's what you can build with it—right now.
...
**1. FairMed-XGB: A Bayesian-Optimised Multi-Metric Framework with Explainability for Demographic Equity in Critical Healthcare Data** (Score: 0.81) 【breakthrough:1】

*In plain English*: Machine learning models deployed in critical care settings exhibit demographic biases, particularly gender disparities, that undermine clinical trust and equitable treatment. This paper introduces FairMed-XGB, a novel framework that systematically de...
...
- **Architecture**: 46 mentions across papers—this is where the field is moving 【trend:architecture】
...
**Research Foundation**: [View Paper](https://arxiv.org/abs/2603.14947v1)

</div>

#### 2. DeFRiS: Silo-Cooperative IoT Applications Scheduling via Decentralized Federated Reinforcement Learning
...
**Research Foundation**: [View Paper](https://arxiv.org/abs/2603.14729v1)

</div>

#### 3. Computational Analysis of Semantic Connections Between Herman Melville Reading and Writing
...
**Research Foundation**: [View Paper](https://arxiv.org/abs/2603.14674v1)
