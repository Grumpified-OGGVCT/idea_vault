...
- Type: dataset
- Research Score: 0.50
- Community Interest: 20,119 downloads, 336 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**muzafin/llama3.2-3b-legal-asisten-sft**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/muzafin/llama3.2-3b-legal-asisten-sft)

**mradermacher/Llama-3.1-70B-Instruct-Jbliterated-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/Llama-3.1-70B-Instruct-Jbliterated-GGUF)

**LLiserginov/Luqwen2-4B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LLiserginov/Luqwen2-4B)

**dhasmana/WAXAL-mas-lug-sog-w2v-bert-2.0**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dhasmana/WAXAL-mas-lug-sog-w2v-bert-2.0)
...
- **Total Papers Scanned**: 469
- **High-Relevance Papers**: 209
- **Curation Quality**: 0.45
