---
layout: default
title: "AI Research Intelligence – 2026-03-26"
date: 2026-03-26 20:29:31 +0000
...
permalink: /daily/2026/03/26/research-intelligence-2026-03-26/
...
### 1. Knowledge-Guided Manipulation Using Multi-Task Reinforcement Learning

**Authors**: Aditya Narendra et al.  
**Research Score**: 0.95 (Highly Significant)  
**Source**: arxiv  

**Core Contribution**: This paper introduces Knowledge Graph based Massively Multi-task Model-based Policy Optimization (KG-M3PO), a framework for multi-task robotic manipulation in partially observable settings that unifies Perception, Knowledge, and Policy. The method augments egocentric vision with an online 3D scene g...
...
[📄 Read Paper](https://arxiv.org/abs/2603.24083v1)

---

### 2. Trust Region Constrained Bayesian Optimization with Penalized Constraint Handling

**Authors**: Raju Chowdhury et al.  
**Research Score**: 0.94 (Highly Significant)  
**Source**: arxiv  

**Core Contribution**: Constrained optimization in high-dimensional black-box settings is difficult due to expensive evaluations, the lack of gradient information, and complex feasibility regions. In this work, we propose a Bayesian optimization method that combines a penalty formulation, a surrogate model, and a trust re...
...
[📄 Read Paper](https://arxiv.org/abs/2603.24567v1)

---

### 3. CVPD at QIAS 2026: RAG-Guided LLM Reasoning for Al-Mawarith Share Computation and Heir Allocation

**Authors**: Wassim Swaileh et al.  
**Research Score**: 0.91 (Highly Significant)  
**Source**: arxiv  

**Core Contribution**: Islamic inheritance (Ilm al-Mawarith) is a multi-stage legal reasoning task requiring the identification of eligible heirs, resolution of blocking rules (hajb), assignment of fixed and residual shares, handling of adjustments such as awl and radd, and generation of a consistent final distribution. T...
...
[📄 Read Paper](https://arxiv.org/abs/2603.24012v1)
...
**Boosting Document Parsing Efficiency and Performance with Coarse-to-Fine Visual Processing** (Score: 0.78)

Document parsing is a fine-grained task where image resolution significantly impacts performance. While advanced research leveraging vision-language models benefits from high-resolution input to boost... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2603.24326v1)

**Comparing Developer and LLM Biases in Code Evaluation** (Score: 0.77)

As LLMs are increasingly used as judges in code applications, they should be evaluated in realistic interactive settings that capture partial context and ambiguous intent. We present TRACE (Tool for R... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2603.24586v1)

**Invisible Threats from Model Context Protocol: Generating Stealthy Injection Payload via Tree-based Adaptive Search** (Score: 0.77)

Recent advances in the Model Context Protocol (MCP) have enabled large language models (LLMs) to invoke external tools with unprecedented ease. This creates a new class of powerful and tool augmented ... This work contributes to the broader understanding of [domain] by [specific contribution].

[📄 Read Paper](https://arxiv.org/abs/2603.24203v1)
...
**jurinho17-sv/news-article-bias-classifier**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jurinho17-sv/news-article-bias-classifier)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kairawal/Qwen3-8B-GA-SynthDolly-1A)

**Ching2602/wanfacesitting**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ching2602/wanfacesitting)

**pathcosmos/EVAFRILL-Mo-3B**

- Type: model
- Research Score: 0.40
- Community Interest: 32 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/pathcosmos/EVAFRILL-Mo-3B)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/xw1234gan/Main_fixed_MATH_3B_step_1)
...
- Knowledge-Guided Manipulation Using Multi-Task Reinforcement... (watch for citations and replications)
- Trust Region Constrained Bayesian Optimization with Penalize... (watch for citations and replications)
- CVPD at QIAS 2026: RAG-Guided LLM Reasoning for Al-Mawarith ... (watch for citations and replications)
...
**1. Knowledge-Guided Manipulation Using Multi-Task Reinforcement Learning** (Score: 0.95) 【breakthrough:1】

*In plain English*: This paper introduces Knowledge Graph based Massively Multi-task Model-based Policy Optimization (KG-M3PO), a framework for multi-task robotic manipulation in partially observable settings that unifies Perception, Knowledge, and Policy. The method au...
...
**2. Trust Region Constrained Bayesian Optimization with Penalized Constraint Handling** (Score: 0.94) 【breakthrough:2】

*In plain English*: Constrained optimization in high-dimensional black-box settings is difficult due to expensive evaluations, the lack of gradient information, and complex feasibility regions. In this work, we propose a Bayesian optimization method that combines a pena...

**Builder takeaway**: Look for implementations on HuggingFace or GitHub in the next 2-4 weeks. Early adopters can differentiate their products with this approach.

[📄 Read Paper](https://arxiv.org/abs/2603.24567v1)

**3. CVPD at QIAS 2026: RAG-Guided LLM Reasoning for Al-Mawarith Share Computation and Heir Allocation** (Score: 0.91) 【breakthrough:3】

*In plain English*: Islamic inheritance (Ilm al-Mawarith) is a multi-stage legal reasoning task requiring the identification of eligible heirs, resolution of blocking rules (hajb), assignment of fixed and residual shares, handling of adjustments such as awl and radd, an...
...
**Research Foundation**: [View Paper](https://arxiv.org/abs/2603.24083v1)
...
**Research Foundation**: [View Paper](https://arxiv.org/abs/2603.24567v1)
...
**Research Foundation**: [View Paper](https://arxiv.org/abs/2603.24012v1)
