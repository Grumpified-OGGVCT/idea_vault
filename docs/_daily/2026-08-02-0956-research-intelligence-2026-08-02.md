...
**mpanchabekasan/indian-recipe-gpt2-demo**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mpanchabekasan/indian-recipe-gpt2-demo)

**syssec-utd/py314-pylingual-v5-mlm**

- Type: model
- Research Score: 0.40
- Community Interest: 1,174 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/syssec-utd/py314-pylingual-v5-mlm)

**stevenlearns/Qwen2.5-1.5B-Instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/stevenlearns/Qwen2.5-1.5B-Instruct)

**stevenlearns/Qwen3-1.7B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/stevenlearns/Qwen3-1.7B)
