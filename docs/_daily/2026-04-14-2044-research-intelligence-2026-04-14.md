...
- Type: model
- Research Score: 0.60
- Community Interest: 43,645 downloads, 694 likes
- [🤗 View on HuggingFace](https://huggingface.co/MiniMaxAI/MiniMax-M2.7)

**open-index/hacker-news**

- Type: dataset
- Research Score: 0.50
- Community Interest: 26,762 downloads, 299 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**Aryanvaidh1712/AI-Humanizer-SaaS**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Aryanvaidh1712/AI-Humanizer-SaaS)

**jejunepixels/Hammershoi-Flux1-LoRA**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jejunepixels/Hammershoi-Flux1-LoRA)

**Jordansky/codellamaCodeLlama-7b-Instruct-hf-ginrummy-smoketest**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Jordansky/codellamaCodeLlama-7b-Instruct-hf-ginrummy-smoketest)
...
- **Total Papers Scanned**: 477
- **High-Relevance Papers**: 212
- **Curation Quality**: 0.44
