---
layout: default
title: "AI Research Intelligence – 2026-05-19"
date: 2026-05-19 21:12:55 +0000
...
permalink: /daily/2026/05/19/research-intelligence-2026-05-19/
...
- **Implementation Watch**: 48 new models/datasets on HuggingFace
...
[📄 Read Paper](https://arxiv.org/abs/2605.18383v1)
...
[📄 Read Paper](https://arxiv.org/abs/2605.18372v1)
...
[📄 Read Paper](https://arxiv.org/abs/2605.18696v1)
...
[📄 Read Paper](https://arxiv.org/abs/2605.18324v1)
...
[📄 Read Paper](https://arxiv.org/abs/2605.18576v1)
...
[📄 Read Paper](https://arxiv.org/abs/2605.18732v1)
...
**WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-it**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-it)

**WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-fr**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-fr)

**WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-es**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-es)

**WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-en**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-en)

**WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-de**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/WindstormLabs/origin-Helsinki-NLP-opus-mt-ca-de)
...
- [A Readiness-Driven Runtime for Pipeline-Parallel Training under Runtime Variability](https://arxiv.org/abs/2605.18750v1)
- [VISAFF: Speaker-Centered Visual Affective Feature Learning for Emotion Recognition in Conversation](https://arxiv.org/abs/2605.18547v1)
- [Semantic Generative Tuning for Unified Multimodal Models](https://arxiv.org/abs/2605.18714v1)
- [Weakly Supervised Cross-Modal Learning for 4D Radar Scene Flow Estimation](https://arxiv.org/abs/2605.18507v1)
...
**Papers in this cluster**:
- [Efficient Lookahead Encoding and Abstracted Width for Learning General Policies in Classical Planning](https://arxiv.org/abs/2605.18674v1)
...
- [scHelix: Asymmetric Dual-Stream Integration via Explicit Gene-Level Disentanglement](https://arxiv.org/abs/2605.18576v1)
- [VISAFF: Speaker-Centered Visual Affective Feature Learning for Emotion Recognition in Conversation](https://arxiv.org/abs/2605.18547v1)
...
**Papers in this cluster**:
- [The Hidden Cost of Contextual Sycophancy: an AI Literacy Intervention in Human-AI Collaboration](https://arxiv.org/abs/2605.18372v1)
- [Forecasting Downstream Performance of LLMs With Proxy Metrics](https://arxiv.org/abs/2605.18607v1)
- [XCTFormer: Leveraging Cross-Channel and Cross-Time Dependencies for Enhanced Time-Series Analysis](https://arxiv.org/abs/2605.18534v1)
- [Continuous Diffusion Scales Competitively with Discrete Diffusion for Language](https://arxiv.org/abs/2605.18530v1)
- [Predictable Confabulations: Factual Recall by LLMs Scales with Model Size and Topic Frequency](https://arxiv.org/abs/2605.18732v1)
...
- [Semantic Generative Tuning for Unified Multimodal Models](https://arxiv.org/abs/2605.18714v1)
- [Weakly Supervised Cross-Modal Learning for 4D Radar Scene Flow Estimation](https://arxiv.org/abs/2605.18507v1)
- [PACE: Geometry-Aware Bridge Transport for Single-Cell Trajectory Inference](https://arxiv.org/abs/2605.18587v1)
...
**Papers in this cluster**:
- [TabH2O: A Unified Foundation Model for Tabular Prediction](https://arxiv.org/abs/2605.18383v1)
- [Ensembling Tabular Foundation Models - A Diversity Ceiling And A Calibration Trap](https://arxiv.org/abs/2605.18696v1)
- [Efficient Lookahead Encoding and Abstracted Width for Learning General Policies in Classical Planning](https://arxiv.org/abs/2605.18674v1)
- [Data Presentation Over Architecture: Resampling Strategies for Credit Risk Prediction with Tabular Foundation Models](https://arxiv.org/abs/2605.18635v1)
- [Forecasting Downstream Performance of LLMs With Proxy Metrics](https://arxiv.org/abs/2605.18607v1)
...
- TabH2O: A Unified Foundation Model for Tabular Prediction... (watch for citations and replications)
- The Hidden Cost of Contextual Sycophancy: an AI Literacy Int... (watch for citations and replications)
- Ensembling Tabular Foundation Models - A Diversity Ceiling A... (watch for citations and replications)
...
- **Architecture**: 44 mentions across papers—this is where the field is moving 【trend:architecture】
...
**Research Foundation**: [View Paper](https://arxiv.org/abs/2605.18383v1)
...
**Research Foundation**: [View Paper](https://arxiv.org/abs/2605.18372v1)
...
**Research Foundation**: [View Paper](https://arxiv.org/abs/2605.18696v1)
...
- **Total Papers Scanned**: 498
- **High-Relevance Papers**: 248
