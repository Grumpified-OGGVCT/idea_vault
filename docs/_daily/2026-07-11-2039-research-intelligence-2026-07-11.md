...
- [🤗 View on HuggingFace](https://huggingface.co/datedgpt/datedgpt-2016-base)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/datedgpt/datedgpt-2022-base)

**ala-la/Qwen3.6-35B-A3B-MLX-3bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ala-la/Qwen3.6-35B-A3B-MLX-3bit)

**datedgpt/datedgpt-2015-base**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/datedgpt/datedgpt-2015-base)
