...
**chunchiliu/deepseek-coder-1.3b-instruct-Gensyn-Swarm-territorial_solitary_ant**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chunchiliu/deepseek-coder-1.3b-instruct-Gensyn-Swarm-territorial_solitary_ant)

**ispras-crawlers/newsxlm-ae**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ispras-crawlers/newsxlm-ae)

**notnoll/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-stubby_silky_cockroach**

- Type: model
- Research Score: 0.40
- Community Interest: 388 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/notnoll/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-stubby_silky_cockroach)
