...
- Type: dataset
- Research Score: 0.50
- Community Interest: 25,400 downloads, 338 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**User01110/cma-1M-exp**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/User01110/cma-1M-exp)

**Agnivarcas/iol-2026-qwen14b-entry**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Agnivarcas/iol-2026-qwen14b-entry)

**Umbasa/DeepSeek-V4-Pro-DSpark-UMBASA-V1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Umbasa/DeepSeek-V4-Pro-DSpark-UMBASA-V1)
