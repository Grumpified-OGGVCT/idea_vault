...
**wepiqx/Ornith-1.5-9B-MTP-ASHQ1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/wepiqx/Ornith-1.5-9B-MTP-ASHQ1-GGUF)

**verbamore/whisper-medium-af-za-cx**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/verbamore/whisper-medium-af-za-cx)

**OliviaRossi/SignOfFour-Q5_K_M-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/OliviaRossi/SignOfFour-Q5_K_M-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/xuzishan/envscaler-qwen3-8b-grpo-step63-20260515)

**Ke96/MyAwesomeModel-TestRepo**

- Type: model
- Research Score: 0.40
- Community Interest: 110 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ke96/MyAwesomeModel-TestRepo)
