...
- [🤗 View on HuggingFace](https://huggingface.co/sakibalfahim/BanglaNews)

**open-index/hacker-news**

- Type: dataset
- Research Score: 0.50
- Community Interest: 25,328 downloads, 336 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**dealignai/Laguna-S-2.1-CRACK-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dealignai/Laguna-S-2.1-CRACK-GGUF)

**yazerakbar/flux-evil-config**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yazerakbar/flux-evil-config)

**6Morpheus6/new_prompt.pt**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/6Morpheus6/new_prompt.pt)
