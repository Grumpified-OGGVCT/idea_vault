...
**SOTAagi2030/MyModel-Threshold60-TestRepo**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/SOTAagi2030/MyModel-Threshold60-TestRepo)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hcsmediagroup/gemma-3-1b-lysiane-advanced-merged)

**UVA-MSBA/ARISE-ADR-NLP**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/UVA-MSBA/ARISE-ADR-NLP)

**gkraker04/Ornstein-Hermes-3.6-27B-SABER**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gkraker04/Ornstein-Hermes-3.6-27B-SABER)
