...
- [naeaeaem/gpt2-finetuned](https://huggingface.co/naeaeaem/gpt2-finetuned)
- [Kibalama/smollm3-jobs-sft](https://huggingface.co/Kibalama/smollm3-jobs-sft)
...
- [PR] feat(project-restructure): Introduce Morgan RAG module ... (watch for citations and replications)
- naeaeaem/gpt2-finetuned... (watch for citations and replications)
- 0d1n/Qwen3-0.6B-Gensyn-Swarm-voracious_pesty_penguin... (watch for citations and replications)
...
- **Total Papers Scanned**: 98
- **High-Relevance Papers**: 12
- **Curation Quality**: 0.12
