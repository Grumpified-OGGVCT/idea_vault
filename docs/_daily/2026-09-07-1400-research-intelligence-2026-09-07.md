...
- Type: model
- Research Score: 0.50
- Community Interest: 211,018 downloads, 265 likes
- [🤗 View on HuggingFace](https://huggingface.co/DavidAU/Qwen3.8-27B-TURBO-Fable-Cold-Fusion-735-882-Heretic-Uncensored-NEO-CODER-MAX-MTP-GGUF)

**efontes/efontes-latin-lemma-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/efontes/efontes-latin-lemma-v2)

**fpadovani/nor-latn-10mb-100mb_seed3407**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/nor-latn-10mb-100mb_seed3407)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sanjaydubey733/bert-base-uncased-sentiment-model)

**astroos/meena-2-marriage**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/astroos/meena-2-marriage)
...
Today's research firehose scanned **402 papers** and surfaced **3 breakthrough papers** 【metrics:1】 across **6 research clusters** 【patterns:1】. Here's what you can build with it—right now.
