...
**rwang220/Yida-Model-14B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rwang220/Yida-Model-14B)

**Nekodeus/flux2-klein-9b-int4-ov**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Nekodeus/flux2-klein-9b-int4-ov)
